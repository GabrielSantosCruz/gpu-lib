...
extern int key_read();
extern void hexs(unsigned int digito0,unsigned lint digito1,unsigned int digito2,unsigned int digito3,unsigned int digito4,unsigned int digito5);
...
void desenha_poligonos(){
  set_draw_triangle(video_BLUE, 1, 20, 20, 1);
